...
import { faSearch, faCaretUp, faCaretDown, faSpinner, faCopy } from "@fortawesome/free-solid-svg-icons";
...
dom.watch();
library.add(faSearch, faSpinner, faCaretUp, faCaretDown, faCopy);
